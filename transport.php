...
<body style="background-color:#C0C0C0;">
	...
	<div class="container" id="about">
		<div class="row padding">
			...
			<div class="col-md-6">
				<br>
				<p class="text-justify"><b>Luas</b> is a tram/light rail system in Dublin, Ireland, which in 2015 carried 34.6 million passengers.There are two main lines: the Green Line, which began operating on 30 June 2004, and the Red Line which opened on 26 September 2004. Since then, both lines have been extended and split into different branches. The system now has fifty-four stations and 36.5 kilometres (22.7 mi) of track.
				<br></br>
		...
		<div class="row padding">
			...
			<div class="col-md-6">
				...
				<img src="img/bus.jpg" class="img-circle img-responsive" alt="circular holding image"/>
			</div>
		</div>
